...
/* harmony import */ var _lib_typemeaway__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/typemeaway */ "./src/assets/js/lib/typemeaway.js");
...
__webpack_require__(/*! foundation-sites */ "./node_modules/foundation-sites/dist/js/foundation.esm.js"); // Select the button


var btn = document.querySelector('.btn-toggle'); // Listen for a click on the button
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#toggle').click(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#overlay').toggleClass('open');
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('nav li a').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#overlay').toggleClass('open');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#toggle").removeClass('active');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").find("#toggle").removeClass("active");
...
/***/ "./src/assets/js/lib/typemeaway.js":
/*!*****************************************!*\
  !*** ./src/assets/js/lib/typemeaway.js ***!
  \*****************************************/
/*! no exports provided */
...
var typed = new typed_js__WEBPACK_IMPORTED_MODULE_0___default.a('#typed', {
  strings: ['만나서 반갑습니다. 제 이름은 여호붕 입니다。', 'Nice to meet you, my name is Haopeng Yu.', '您好，認識你很高興！ 我叫余浩鵬。'],
  typeSpeed: 100,
  backSpeed: 50,
  showCursor: true,
  backDelay: 5,
...
module.exports = __webpack_require__(/*! /Users/haopengyu/Documents/Coding/Websites/haopengsteveyu/src/assets/js/app.js */"./src/assets/js/app.js");
